...
! language allows.
! 
! Note: this should not involve the calling of any functions/methods, but
! should be interpreted by the compiler or interpreter as an integer
! written to a given base.
! 
