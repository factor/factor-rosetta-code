...
! -   Remove extraneous punctuation, but keep at least sentence-ending
!     punctuation characters . ! and ?
! -   Keep account of what words follow words and how many times it is
!     seen, (treat sentence terminators as words too).
! -   Keep account of what words follow two words and how many times it is
!     seen, (again treating sentence terminators as words too).
! -   Assume that a sentence starts with a not to be shown full-stop
