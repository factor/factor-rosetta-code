...
! all factors (or primes) up to the √ X  of that integer, either to find
! the factors of that integer, or to determine primality.
! 
...
! 
! -   -   the Isqrt of the integers from 0 ───► 65  (inclusive), shown in
!         a horizontal format.
