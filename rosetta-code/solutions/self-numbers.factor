! A number n is a self number if there is no number g such that g + the
! sum of g's digits = n. So 18 is not a self number because 9+9=18, 43 is
! not a self number because 35+5+3=43.
! 
! The task is:
! 
