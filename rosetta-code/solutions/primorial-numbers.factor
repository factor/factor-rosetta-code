! Primorial numbers are those formed by multiplying successive prime
! numbers.
! 
...
! :;* ∙ ∙ ∙
! 
! To express this mathematically, primorial_(n) is the product of the
! first n (successive) primes:
! 
!     $primorial_n = \prod_{k=1}^n prime_k$
! 
!     
! 
!         ─── where prime_(k) is the k^(th)'' prime number.
! 
...
! -   Show the length of primorial numbers whose index is: 10 100 1,000
!     10,000 and 100,000.
! -   Show the length of the one millionth primorial number (optional).
! -   Use exact integers, not approximations.
! 
! By length (above), it is meant the number of decimal digits in the
! numbers.
! 
! Related tasks:
! 
