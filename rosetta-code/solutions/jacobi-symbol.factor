! The Jacobi symbol is a multiplicative function that generalizes the
! Legendre symbol. Specifically, the Jacobi symbol (a | n) equals the
! product of the Legendre symbols (a | p_i)^(k_i), where n =
