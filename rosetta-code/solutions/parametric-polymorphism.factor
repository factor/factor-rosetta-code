...
! that uses it.
! 
! A good example is a container type, let's say a binary tree, together
! with some function that traverses the tree, say, a map-function that
! operates on every element of the tree.
! 
