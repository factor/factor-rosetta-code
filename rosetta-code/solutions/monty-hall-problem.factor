...
! 
! The car and the goats were placed randomly behind the doors before the
! show.
! 
! Rules of the game:
! 
! After you have chosen a door, the door remains closed for the time
! being.
! 
! The game show host, Monty Hall, who knows what is behind the doors, now
! has to open one of the two remaining doors, and the door he opens must
! have a goat behind it.
! 
...
! remaining door.
! 
! Imagine that you chose Door 1 and the host opens Door 3, which has a
! goat.
! 
...
! Note:
! 
! The player may initially choose any of the three doors (not just Door
! 1), that the host opens a different door revealing a goat (not
...
! contrasted with the strategy of the contestant always switching his
! guess.
! 
