! Given a List (abstract data type) of integer values, find all its
...
! minimum, as a percentage of the local maximum.
! 
! [A plot highlighting decreasing contiguous subsequences]
! 
! Using the following example sequence, display the count of subsequences
! per group.
! 
...
!     89
! 
! It's OK to hard code the example sequence or read it from a file.
! Plotting decreasing subsequences is optional.
