! Most programming languages offer support for subroutines. When execution
! changes between subroutines, different sets of variables and functions
...
! ("static scoping" or "lexical scoping"). These sets may also be defined
! by special modifiers to the variable and function declarations.
! 
