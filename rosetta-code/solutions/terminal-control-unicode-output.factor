...
! 
! Note that it is permissible to use system configuration data to
! determine terminal capabilities if the system provides such a facility.
! 
! Category:Terminal control Category:Unicode
