...
!     the same choice again; or a roll of 1 loses the player's total
!     points for that turn and their turn finishes with play passing to
!     the next player.
! 2.  Holding: The player's score for that round is added to their total
!     and becomes safe from the effects of throwing a one. The player's
