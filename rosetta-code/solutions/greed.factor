...
! 
! This game is played on a grid of 79 column by 22 rows of random numbers
...
! moving around (all 8 directions are allowed in this grid).
! 
! When you move in a direction, N number of grid squares are erased
! ("eaten") in that direction, N being the first number in that direction.
! 
! Your score reflects the total number of squares "eaten".
! 
! You may not make a move that places you off the grid or over a
! previously eaten square.
! 
