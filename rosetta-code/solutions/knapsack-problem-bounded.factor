...
! weight of all items is too much. He adds a value to each item. The value
! represents how important the thing for the tourist.
! 
! The list contains which items are the wanted things for the trip, what
! is the weight and value of an item, and how many units does he have from
! each items.
! 
! This is the list:
! 
!     
! 
!         {| style="text-align: left; width: 55%;" border="4"
!         cellpadding="2" cellspacing="2"
! 
! |+ Table of potential knapsack items |- style="background-color:
! rgb(255, 204, 255);" ! item !! weight (dag) (each) !! value (each) !!
! piece(s) |- | map || 9 || 150 || 1 |- | compass || 13 || 35 || 1 |- |
! water || 153 || 200 || 2 |- | sandwich || 50 || 60 || 2 |- | glucose ||
! 15 || 60 || 2 |- | tin || 68 || 45 || 3 |- | banana || 27 || 60 || 3 |-
! | apple || 39 || 40 || 3 |- | cheese || 23 || 30 || 1 |- | beer || 52 ||
! 10 || 3 |- | suntan cream || 11 || 70 || 1 |- | camera || 32 || 30 || 1
...
! |- | sunglasses || 7 || 20 || 1 |- | towel || 18 || 12 || 2 |- | socks
! || 4 || 50 || 1 |- | book || 30 || 10 || 2 |- style="background-color:
! rgb(255, 204, 255);" | knapsack || ≤400 dag || ? || ? |}
! 
! The tourist can choose to take any combination of items from the list,
! and some number of each item is available (see the column piece(s) in
! the list above).
! 
