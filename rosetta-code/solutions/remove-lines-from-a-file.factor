...
! 
! For the purpose of this task, line numbers and the number of lines start
! at one, so to remove the first two lines from the file foobar.txt, the
...
! 
! An appropriate message should appear if an attempt is made to remove
! lines beyond the end of the file.
