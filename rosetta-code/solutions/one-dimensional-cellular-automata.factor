...
! current generation.
! 
! If, in the following table, a live cell is represented by 1 and a dead
! cell by 0 then to generate the value of the cell at a particular index
! in the array of cellular values you use the following table:
! 
! 000 -> 0  # 
! 001 -> 0  #
