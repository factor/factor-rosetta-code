...
! convex polygon (the “clip polygon”).
! 
! It is used in computer graphics (especially 2D graphics) to reduce the
...
! 
! (When displaying you may use either a north-west or a south-west origin,
! whichever is more convenient for your display mechanism.)
