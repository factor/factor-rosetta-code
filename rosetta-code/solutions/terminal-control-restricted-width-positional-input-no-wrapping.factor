...
! terminal screen. Data entry fields should be restricted to a specific
! length, and it should not be possible for the cursor to move beyond the
! input length.
! 
...
! characters.
! 
! Note: In this task input wrapping is not allowed. (See Terminal
! control/Restricted width positional input/With wrapping) for input
! wrapping variant.
! 
! For a similar task using a graphical user interface, see Graphical User
! Interface/Restricted width positional input/No wrapping.
! 
