...
! 
! -   -   there is one and only one king of each color (one black king and
!         one white king);
!     -   the kings must not be placed on adjacent squares;
!     -   there can not be any pawn in the promotion square (no white pawn
!         in the eighth rank, and no black pawn in the first rank);
