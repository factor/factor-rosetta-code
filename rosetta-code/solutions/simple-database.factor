...
! 
! The tool should have a command-line interface to enter at least two
! different values.
! 
! The entered data should be stored in a structured format and saved to
! disk.
! 
! It does not matter what kind of data is being tracked. It could be a
! collection (CDs, coins, baseball cards, books), a diary, an electronic
! organizer (birthdays/anniversaries/phone numbers/addresses), etc.
! 
...
! standardized. A natively available format that doesn't need an external
! library is preferred. Avoid developing your own format if you can use an
