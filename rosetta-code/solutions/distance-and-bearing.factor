...
! openflights.org airports.dat as reference.
! 
! A request comes from an airplane at position ( latitude, longitude ): (
! 51.514669, 2.198581 ).
! 
! Your report should contain the following information from table
! airports.dat (column shown in brackets):
! 
! Name(2), Country(4), ICAO(6), Distance and Bearing calculated from
! Latitude(7) and Longitude(8).
! 
