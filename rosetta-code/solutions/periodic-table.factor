...
! Details;
! 
! The representation of the periodic table may be represented in various
! way. The one presented in this challenge does have the following
! property : Lantanides and Aktinoides are all in a dedicated row, hence
! there is no element that is placed at 6, 3 nor 7, 3.
! 
