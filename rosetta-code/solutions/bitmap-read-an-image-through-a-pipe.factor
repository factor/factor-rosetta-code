! This task is the opposite of the PPM conversion through a pipe. In this
! task, using a delegate tool (like cjpeg, one of the netpbm package, or
! convert of the ImageMagick package) we read an image file and load it
