! Definition
! 
! A Giuga number is a composite number n which is such that each of its
! distinct prime factors f divide (n/f - 1) exactly.
! 
! All known Giuga numbers are even though it is not known for certain that
! there are no odd examples.
! 
! Example
! 
