! According to Wikipedia; assertions can function as a form of
! documentation: they can describe the state the code expects to find
! before it runs (its preconditions), and the state the code expects to
