...
! that is immediately followed by an identical character (or characters).
! Another word choice could've been duplicated character, but that might
! have ruled out (to some readers) triplicated characters ··· or more.
! 
