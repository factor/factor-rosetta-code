! A magic square is an NxN square matrix whose numbers consist of
...
! 
! A magic square of singly even order has a size that is a multiple of 4,
! plus 2 (e.g. 6, 10, 14). This means that the subsquares have an odd
