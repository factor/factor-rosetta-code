...
! 
! Plot execution time vs. input sequence length dependencies for various
! implementation of sorting algorithm and different input sequence types
! (example figures).
! 
...
! 
! For example, consider Bubble Sort, Insertion sort, Quicksort or/and
! implementations of Quicksort with different pivot selection mechanisms.
...
! :# Plot timings.
! 
! :# What conclusions about relative performance of the sorting routines
! could be made based on the plots?
! 
! Category:Sorting
