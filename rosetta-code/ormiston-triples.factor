! Definition
! 
! An Ormiston triple is three consecutive prime numbers which are
! anagrams, i.e. contain the same decimal digits but in a different order.
! 
! Example
! 
! The three consecutive primes (11117123, 11117213, 11117321) are an
! Ormiston triple.
! 
! Task
! 
