! The first turtle graphic discussed in Mindstorms: Children, Computers,
! and Powerful Ideas by Seymour Papert is a simple drawing of a house. It
! is a square with a triangle on top for the roof.
! 
! For a slightly more advanced audience, a more practical introduction to
! turtle graphics might be to draw a bar chart.
! 
! []
! 
! Task:
