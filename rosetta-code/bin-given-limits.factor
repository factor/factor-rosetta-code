! You are given a list of n ascending, unique numbers which are to form
! limits for n+1 bins which count how many of a large set of input numbers
! fall in the range of each bin.
! 
...
! function that given the same list of limits and the binning will print
! the limit of each bin together with the count of items that fell in the
! range.
! 
