...
! 
! The function should return a boolean that is true if and only if the
! distribution is one that a uniform distribution (with appropriate number
! of degrees of freedom) may be expected to produce.
! 
