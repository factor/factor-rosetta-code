...
! electron head  | electron tail  | |- | electron tail  | conductor | |- |
! valign=top | conductor | valign=top | electron head  | if 1 or 2 cells
! in the neighborhood of the cell are in the state “electron head” |- |
