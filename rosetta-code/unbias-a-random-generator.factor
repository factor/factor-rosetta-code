...
! probability of a one occurring, P₁, is not the same as P₀, the
! probability of a zero occurring, the probability of the occurrence of a
! one followed by a zero is P₁ × P₀, assuming independence. This is the
! same as the probability of a zero followed by a one: P₀ × P₁.
! 
! Task details:
! 
