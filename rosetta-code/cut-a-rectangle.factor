! A given rectangle is made from m × n squares. If m and n are not both
! odd, then it is possible to cut a path through the rectangle along the
! square edges such that the rectangle splits into two connected pieces
