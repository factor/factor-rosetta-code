! Suppose we have a sequence of prime sums, where each term P_(n) is the
...
! P = 2, 5, 10, 17, 28, etc.
! 
! Further; suppose we have a sequence of composite sums, where each term
! C_(m) is the sum of the first m composites.
! 
! C = (4), (4 + 6), (4 + 6 + 8), (4 + 6 + 8 + 9), (4 + 6 + 8 + 9 + 10), ...
! 
! C = 4, 10, 18, 27, 37, etc.
! 
! Notice that the third term of P; P₃ (10) is equal to the second term of
! C; C₂ (10);
! 
! Task
! 
