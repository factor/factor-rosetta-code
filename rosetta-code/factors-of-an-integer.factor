...
! 
! These factors are the positive integers by which the number being
! factored can be divided to yield a positive integer result.
! 
! (Though the concepts function correctly for zero and negative integers,
! the set of factors of zero has countably infinite members, and the
