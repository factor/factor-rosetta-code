...
! 
! On an ASCII based system, if the control codes are stripped, the
! resultant string would have all of its characters within the range of 32
! to 126 decimal on the ASCII table.
! 
