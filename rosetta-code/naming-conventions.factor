! Many languages have naming conventions regarding the identifiers used in
! the language, its libraries, and programs written in the language. Such
! conventions, which may be classified as de facto or de jure depending on
! how they are enforced, often take the form of rules regarding prefixes,
! suffixes, and the use of upper-case and lower-case characters.
! 
! The naming conventions are sometimes a bit haphazard, especially if the
! language and/or library has gone through periods of evolution. (In this
! case: give a brief example and description.)
! 
...
! "hide" raw Operating System calls from the non systems-programmer,
