...
! 
! Lets call  i -> j a transition if  i is the last decimal digit of a
! prime, and  j the last decimal digit of the following prime.
! 
! Task:
! 
! Considering the first one million primes. Count, for any pair of
! successive primes, the number of transitions  i -> j and print them
! along with their relative frequency, sorted by  i.
! 
! You can see that, for a given  i, frequencies are not evenly
! distributed.
! 
! Observation:
! 
