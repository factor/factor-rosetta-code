...
! -   "Non-greedy" movement.
! 
! The tiles that were created by combining other tiles should not be
! combined again during the same turn (move). That is to say, that moving
! the tile row of:
! 
!                [2][2][2][2] 
! 
...
! 
! If more than one variant of combining is possible, move direction shall
! indicate which combination will take effect. For example, moving the
! tile row of:
! 
!                ...[2][2][2] 
! 
